...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self, who, spawnpoint, *groups):
        pg.sprite.Sprite.__init__(self, *groups)
        self.image = self.images[who]
        self.rect = self.image.get_rect(x = spawnpoint, y = 1000)
...
async def main(winstyle=0):
    ...
    player1 = Player(0, 900, all)
    player2 = Player(1, 300, all)
